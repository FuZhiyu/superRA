...
| **task-tree** | Directory-tree task tooling — filesystem hierarchy as task hierarchy, `task.md` per task, sibling-only dependencies, status rollup, live dashboard server, and legacy `PLAN.md` / `RESULTS.md` migration. Load-on-demand by orchestrators, planners, and contributors. |
