...
| **report-in-markdown** | Markdown style guide for any agent writing markdown. Carries the always-applicable file-link citation rule (`[file.py:42](file.py#L42)` form with line anchors), with on-demand references for figures, LaTeX math, tables, and Stage 2 `RESULTS.md` final-form discipline. |
