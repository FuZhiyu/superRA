...
Load `superRA:handoff-doc` on demand if you need the full discipline (four document principles, stale-content checklist, User Decisions Log format, full anatomy templates) — for example, if the doc's structure is unclear, you are reviewing an unusual structural edit, or you are reviewing a Stage 2 RESULTS.md maturation.
