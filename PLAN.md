...
>    → implemented: deleted §Sentence vs structural scope header + body (`skills/writing/references/polish.md:5-7`)
>
...
>    → implemented: deleted §Inline-directive convention header + body (`skills/writing/references/polish.md:9-11`); §Input shape A items 2–3 already carry the operational rule, no fold-in needed
>
...
>    → implemented: deleted the line entirely (`skills/writing/references/polish.md` former §Input shape A item 4); re-checked after items 1–2 — no load-bearing residue survives the gate
