...
>    → implemented: option (a) — swapped `style-checklist.md` → `style.md` and `structure-checklist.md` → `structure.md` on lines 9, 10, 11, 36, 37 of `docs/writing-references/README.md`; post-edit `grep` for `style-checklist|structure-checklist` in the file returns empty.
