...
>    -> implemented: revised the expected-results statement to remove Codex decision-log coverage and explicitly record the Claude-only limitation. ([PLAN.md](PLAN.md))
