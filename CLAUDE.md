...
- **`semantic-merge`** owns *semantic sync discipline* — intent research, conflict resolution, workflow sync author/reviewer mode references, standalone full-merge mode, Sync Map / impact formats, sync commit boundaries, and research-meaningful conflict escalation.
