...
| Reproduction-graph discipline — what earns a step, graph and script design, step retirement, boundary inputs, check steps, the rerun-or-accept judgment on a stale step, diagnosis, graph review, Protect and completion duties | `reproducibility` |
