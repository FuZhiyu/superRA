...
| Reproduction-graph discipline — what earns a step, step retirement, the rerun model, boundary inputs, check steps, graph review, Protect and completion duties | `reproducibility` |
