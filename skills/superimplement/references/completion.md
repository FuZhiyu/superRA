...
3. **Reproducibility verification.**
   - `superra repro build --tier required --upstream`, then a clean `superra repro status --tier required --upstream` (`../../reproducibility/references/protect-and-completion.md` §The completion gate).
