...
3. **Reproducibility verification.**
   - `superra repro build <targets> --upstream`, then a clean `superra repro status <targets> --upstream`, on the completion targets (`../../reproducibility/references/protect-and-completion.md` §The completion gate).
