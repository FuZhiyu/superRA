...
In standalone use, wait for explicit approval. During INTEGRATE, `superintegrate/references/mature-consolidate.md` owns the later combined gate and its recovery loop.
