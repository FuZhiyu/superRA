...
Review-agent reference. Load when extracting from a claimed included or escalated paper; this is the extraction-depth checklist for the same claimed-read session.
