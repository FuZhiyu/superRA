...
3. `superintegrate` selects how key results will be documented and protected, syncs against the integration base, matures the permanent record and task tree, obtains approval for a temporary refactoring task, executes that refactoring, and performs the final merge / PR / cleanup action.
