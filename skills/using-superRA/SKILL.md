...
| Utility | `report-in-markdown` | Markdown style guide for any agent writing markdown — always-loaded alongside `using-superra`. Carries the file-link citation rule plus on-demand references for figures, LaTeX math, tables, and Stage 2 final-form. |
