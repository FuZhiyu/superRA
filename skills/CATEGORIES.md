...
| `report-in-markdown` | Markdown style guide for any agent writing markdown — always-applicable file-link citation rule plus progressive-reveal references for figures, LaTeX math, tables, and Stage 2 final-form. Loaded by every agent. |
