...
> **Main-side change (2026-04-19):** `origin/main` added autoload / ensure hooks for workflow-skill loading; touches no analysis files but adds `hooks/autoload-superra`, `hooks/ensure-using-superra`, and `hooks/ensure-agent-orchestration`, and updates `README.md §Hooks`. Affects Tasks 5, 7 (README edit conflicts).
