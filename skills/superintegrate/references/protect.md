...
1. **Survey the provisional record** — task tree, result files, existing documentation, relevant outputs. Identify reader-distinguishable findings and maintenance outcomes, not every intermediate number.
2. **Propose the protection, documentation, and consolidation choices** — a recommendation plus meaningful alternatives for:
