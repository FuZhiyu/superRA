...
Whole-section drafts are multi-task work — route through `superplan` (`.plan/` task tree). Paragraph-scale drafts (an abstract from the body, a paragraph from notes) terminate at edit + commit.
