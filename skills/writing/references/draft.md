...
4. **Self-check** against `style.md` §Gated Checklist (sentence-level) and `structure.md` §Gated Checklist (section anatomy) — a real walk, not a rubber stamp; fix non-compliant prose before handoff.
