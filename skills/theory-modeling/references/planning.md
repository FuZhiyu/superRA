...
6. **Present the inventory and get researcher approval.** Write it into the top `superRA/task.md` objective as a scoped subsection using this structure, then ask the researcher to confirm before proceeding to task drafting:
...
**Never:**
- Proceed to task drafting on the basis of a verbal description only. The inventory must be written into the top `superRA/task.md` objective.
