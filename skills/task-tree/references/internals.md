...
- **Own writes** — after a `task.md` change the hook runs detection once more and discards the result, absorbing the ancestor-status rollups reconcile wrote.
