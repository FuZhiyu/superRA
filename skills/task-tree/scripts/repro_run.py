...
def build_parser() -> argparse.ArgumentParser:
    ...
    accept = sub.add_parser("accept", help="Preview or accept the current reviewed baseline")
    accept.add_argument("targets", nargs="+")
    accept.add_argument("--reason", default="", help="Why the current results are accepted (required to apply)")
