...
The pinned versions match the CDN tags in `templates/base.html` (`markdown-it@14`, `katex@0.16`, `markdown-it-texmath@1`, `@highlightjs/cdn-assets@11`). The markdown/math CDN tags resolved to the exact versions below on 2026-06-01; the highlight.js tag resolved on 2026-06-11.
