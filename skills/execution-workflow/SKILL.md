...
**In direct mode:** Steps 1–2 are done by the main agent directly (invoke `superRA:implementer-protocol`). Steps 3–4 are unchanged — still dispatch reviewer subagents.
