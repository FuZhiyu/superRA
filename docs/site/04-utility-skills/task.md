...
- [**report-in-markdown**](#/04-utility-skills/05-report-in-markdown) — the house style guide for task files and reports — line-anchored source links, KaTeX-safe math, consistent tables — so citations are clickable and a display equation doesn't get silently swallowed into a paragraph.
