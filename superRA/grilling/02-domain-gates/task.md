...
The section rename this exposes — `## Planner Guidance` reads as advice when the real distinction is binding versus information — is [task-tree/additional-information-rename](../../task-tree/additional-information-rename/task.md), not this task.
