...
Run from the worktree root:
  uv run --project skills/task-system --with httpx python \
    superRA/task-system/dashboard/multi-worktree-serving/06-watcher-teardown-spin/attachments/live_verify.py
"""
...
SCRIPTS = REPO / "skills" / "task-system" / "scripts"
PORT = 8137
