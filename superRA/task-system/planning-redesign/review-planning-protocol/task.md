...
- task anatomy lives in `skills/task-system/references/task-file-contract.md`; objective/guidance semantics live in `skills/superplan/references/task-tree-design.md`;
...
- Moved `review-planning-protocol` task records under `superRA/` and later consolidated them under `task-system/planning-redesign/review-planning-protocol`; active planning-review command references use `--plan-root superRA`.
