...
- **Tree tooling** (tree concepts, query/frontier/DAG, mutation command surface, dashboard, migration) → `task-system/SKILL.md`, load-on-demand.
- **Planner depth** (objective writing, splitting, placement, results shape, stale-content, anatomy) → `task-system/references/planning.md`.
- **Contributor depth** (data layer, hooks, migration internals) → `task-system/references/internals.md`.
