...
Both migration paths updated in [`plan_migrate.py`](skills/task-tree/scripts/plan_migrate.py).
...
102 tests pass. New test classes in [`test_task_tree.py`](skills/task-tree/scripts/test_task_tree.py):
