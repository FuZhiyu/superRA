...
| 33961 | the **real installed dashboard** (`~/.local/share/uv/tools/superra-task-tree`, serving a real project's task tree) | **2** (leaks accumulate per disconnect) |
