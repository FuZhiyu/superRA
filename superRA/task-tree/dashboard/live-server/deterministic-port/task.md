...
**Files to modify:**
- `skills/task-tree/scripts/plan_dashboard.py` — add `_default_port()`, update arg default and `main()` logic.
...
Implemented in [plan_dashboard.py:1555-1567](skills/task-tree/scripts/plan_dashboard.py#L1555-L1567).

Changes made to `skills/task-tree/scripts/plan_dashboard.py`:
