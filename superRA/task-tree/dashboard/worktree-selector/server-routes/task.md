...
Add worktree listing and switching routes to `plan_dashboard.py` (`skills/task-tree/scripts/plan_dashboard.py`). Refactor the module-level state to support hot-swapping `PLAN_ROOT` at runtime.
...
All changes are in [`plan_dashboard.py`](../../../../../skills/task-tree/scripts/plan_dashboard.py).
