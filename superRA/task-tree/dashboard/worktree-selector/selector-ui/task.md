...
Add a worktree selector dropdown to the dashboard header bar in `skills/task-tree/scripts/templates/base.html`. The dropdown lets the user switch which worktree's `.plan/` is displayed.
...
All changes in [base.html](../../../../../skills/task-tree/scripts/templates/base.html).
