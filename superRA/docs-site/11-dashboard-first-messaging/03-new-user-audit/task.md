...
- **Feature slide design once the vertical lands? (intent decision) — RESOLVED.** The user decided (2026-06-17) to feature slide-design now, ahead of the `slide-design-vertical` → trunk merge, listed alongside the domain skills on both front doors. Carried out in the sibling task [`04-why-sections-and-slide-design`](../04-why-sections-and-slide-design/task.md); this audit's accuracy-driven drop is intentionally reversed there per the user's authority.
