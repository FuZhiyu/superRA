...
- CI builds the site once per published ref into URL subdirectories (e.g. `/<default-branch>/`, `/dev/`), extending the `08-deploy` workflow; one ref remains the root/default.
