...
- [Scoped verification and adoption](11-scoped-verification/task.md) implements the accepted tier names, check coverage, pilot improvements, and separate targeted/complete forced reruns; independent review is pending.
