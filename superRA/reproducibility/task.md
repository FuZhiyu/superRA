...
- [Scoped verification and adoption](11-scoped-verification/task.md) implements the accepted tier names, check coverage, and pilot improvements; independent review is pending.
