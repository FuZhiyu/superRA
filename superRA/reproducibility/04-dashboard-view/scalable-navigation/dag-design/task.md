...
The researcher replaced the default-hidden preview requirement with responsive, adjustable panes and requested more tree-sidebar width. Implement adaptive side/bottom placement, explicit remembered visibility, accessible width/height dividers, and generous sidebar sizing. Earlier verification of default-hidden entry is superseded; refresh the affected behavior checks and Results. Keep the approved independent-DAG layout and arrow behavior intact.
