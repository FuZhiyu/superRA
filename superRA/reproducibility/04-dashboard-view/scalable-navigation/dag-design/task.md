...
The user’s research overview revealed that correctly routed arrows can still imply dependencies when unrelated cards share the upstream column. Add visual separation based on connected components; previously approved controls and arrow semantics remain in scope for regression protection.
