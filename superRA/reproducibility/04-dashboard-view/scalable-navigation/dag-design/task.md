...
- **Reproduction:** the existing browser and interaction steps cover these runtime and test changes. This preview revision used direct test invocations and temporary screenshots; the committed screenshot bundle and lock retain the earlier run and are not current freshness evidence.
