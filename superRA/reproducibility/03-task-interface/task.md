...
- **`task check`** gains the `reproduction` category wired to the validation findings of [01-section-contract](../01-section-contract/task.md) and runs it by default; a fresh clone with never-built canon steps stays clean at `[INFO]`.
