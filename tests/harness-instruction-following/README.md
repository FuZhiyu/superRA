...
| **LC020** | `superimplement` orchestration default + direct-mode exceptions | — | [test_transcript_assertions.py](test_transcript_assertions.py), [test_contract.py::…codex_orchestrator_sample](test_contract.py#L363) | [orchestrator-live-smoke.sh](orchestrator-live-smoke.sh) (built) | [orchestrator-live-smoke.sh](orchestrator-live-smoke.sh) `HARNESS=codex` (built) | Dispatch or documented fallback is **fixture-covered**. Orchestrator dispatch smoke is **built; its Claude live run was not part of the 08–12 expansion**, and Codex live is pending. |
